    ...
    def __init__(self, args):
        ...
        if self.tgt_pos_emb:
            self.tgt_pos_embeddings = nn.Embedding(args.max_tgt_len + 2,
                                                   self.dec_input_size)
            # self.tgt_pos_embeddings = Gau2Embedder(self.dec_input_size, 
            #                                     depth = 2, sigma = 0.003, 
            #                                     max_len=args.max_tgt_len+2,
            #                                     dropout=args.dropout_emb)
...
class Encoder(nn.Module):
    def __init__(self,
        ...
        # self.gau = Gau2Embedder(input_size, depth = 1, max_len=input_size, dropout=args.trans_drop)
...
class Transformer(nn.Module):
    ...
    def _run_forward_ml(self,
        ...
        position_rep = kwargs['position_rep']
