...
class VecEmbedding(nn.Module):
    def __init__(self, vec_size,
        ...
        if self.position_encoding:
            ...
            self.pe = Gau2Embedder(self.embedding_size, depth = 1, sigma = 0.003)
...
class Embeddings(nn.Module):
    ...
    def __init__(self, word_vec_size,
        ...
        if self.position_encoding:
            ...
            # pe = Gau2Embedder(self.embedding_size, depth = 2, sigma = 0.003)
            pe = Gau2Embedder(self.embedding_size, depth = 2, sigma = 0.003, dropout=dropout)
